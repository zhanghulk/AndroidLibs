...
public class PrintLog {
  ...
  //是否为缓冲区模式，可以减少IO此时，自己控制缓冲区，可以提高效率
    ...
    private void doRenderFiles() {
    	renderLogFiles();
		//文件数量过多，删除旧的文件
		deleteOldFiles();
    }
    
    private void doRenderFilesAsync() {
    ...
    private void renderLogFiles() {
		...
		PrintUtil.w(TAG, "renderLogFiles： logFileCount= " + logFileCount);
    }
