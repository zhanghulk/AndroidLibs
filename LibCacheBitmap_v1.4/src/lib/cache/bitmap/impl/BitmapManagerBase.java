...
public class BitmapManagerBase extends BitmapBase {
	...
	public BitmapManagerBase(Context context, int cacheCapacity, int poolNum) {
	 ...
	 */
	public void loadBmpIntelligent( String url, BitmapLoadCallback callback) {
	 ...
	 * @param callback  post cache bitmap if exist, or bitmap is null  in mobile data mode
	 */
	public void loadBmpIntelligent(String url, Bitmap defBitmap, BitmapLoadCallback callback) {
		boolean mobileData = isMobileDataMode(context);
		loadBitmap(context, null, url, FIGURE_NO_FLAG, defBitmap, mobileData, callback);
	}

	public void loadBitmap(String url, BitmapLoadCallback callback) {
		loadBitmap(context, null, url, FIGURE_NO_FLAG, defaultBitmap, false, callback);
	}
	
	public void loadBitmap(String url, BitmapLoadCallback callback, boolean isCacheMode) {
		loadBitmap(context, null, url, FIGURE_NO_FLAG, defaultBitmap, isCacheMode, callback);
	}
	
	public void loadBitmap(String url, Bitmap defBmp, boolean isCacheMode, BitmapLoadCallback callback) {
		loadBitmap(context, null, url, FIGURE_NO_FLAG, defBmp, isCacheMode, callback);
	}
	
	public void loadBitmap(String url, int defBmpRasid, boolean isCacheMode, BitmapLoadCallback callback) {
	...
	public synchronized void loadBitmap(Context context, final ImageView imageView, String url,
			int figureFlag, Bitmap defBitmap, boolean isCacheMode, BitmapLoadCallback callback) {
	 ...
	 */
	public synchronized void loadBitmap(Context context, final ImageView imageView, String url,
			int figureFlag, final int width, final int height,  Bitmap defBitmap, 
			boolean isCacheMode, BitmapLoadCallback callback) {
	...
	public void startDownLoadNetBmp(Context context, final ImageView imageView, final String url, 
			final int figureFlag, final BitmapLoadCallback callback) {
	...
	public void startDownLoadNetBmp(final Context context, final ImageView imageView, final String url, 
			final int figureFlag, final int width, final int height, final BitmapLoadCallback callback) {
	 ...
	 * @param isNoNetPrompt
	 */
	public void downlodNetBitmap(final Context context, final String url, final Handler handler) {
		...
		pool.execute(new Runnable() {
			public void run() {
				Bitmap bitmap = null;
				if(debug) Log.d(TAG, "executing url: " + url);
	...
	public void handleResultBitmap(Context context, final ImageView imageView, Bitmap bitmap, String url, int figureFlag, 
			final int width, final int height, boolean cacheEnable,  BitmapLoadCallback callback) {
		if(cacheEnable) {
