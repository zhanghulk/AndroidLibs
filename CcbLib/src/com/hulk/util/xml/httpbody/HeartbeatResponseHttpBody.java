...
import com.hulk.byod.parser.xml.msg.HeartbeatResponseTx;
import com.hulk.byod.parser.xml.msg.HeartbeatResponseTx.TxBody;
import com.hulk.byod.parser.xml.msg.base.ResponseTXHeader;
import com.hulk.byod.parser.entity.HulkPolicy;

/**
 * 心跳接口请求返回结果响应 (网络传输字符串需要进行加密)
...
public class HeartbeatResponseHttpBody extends HttpBodyBase<HeartbeatResponseTx> {
    ...
    private HulkPolicy mPolicy = null;
    ...
    public long getIntervalMillis() {
        ...
        if (!TextUtils.isEmpty(intervalStr)) {
            try {
                ...
                Log.w(TAG, "Hulk Heartbeat intervalMillis= " + intervalMillis);
            } catch (Throwable th) {
