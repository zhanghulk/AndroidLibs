package com.hulk.byod.parser.parsers;

import android.util.Log;

import com.hulk.byod.parser.entity.HulkPolicy;
import com.hulk.byod.parser.xml.httpbody.AuthResponseHttpBody;
...
public class AuthResponseParser extends AbsXmlParser<AuthResponseHttpBody> {
    ...
    private static boolean parsePolicy(XmlPullParser parser, HulkPolicy policy) throws XmlPullParserException, IOException {
        String name = parser.getName();
        String value = nextText(parser);
