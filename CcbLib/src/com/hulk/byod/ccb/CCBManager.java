...
import com.hulk.byod.ccb.xml.httpbody.AuthRequestHttpBody;
import com.hulk.byod.ccb.xml.httpbody.HeartbeatRequestHttpBody;
import com.hulk.byod.ccb.xml.httpbody.RegisterRequestHttpBody;
...
public class CCBManager {

    public final static String TAG = "CCB";
    ...
    public static HeartbeatRequestHttpBody getHeartbeatRequestHttpBody(Context context, String username, int onlineStatus) {
        RequestTXHeader header = CCBManager.getRequestTXHeader(context, CCBManager.HEARTBEAT_TRADE_CODE);
        TerminalInfo terminalInfo = getTerminalInfo(username, onlineStatus);
        ActivityJsonArray array = CCBLogManager.getInstance().readArray();
    ...
    public static RegRequest getRegRequest(String username, String password, String mobile) {
        ...
        request.DESCRIBE = "FREE register CCB";
        return request;
    }
