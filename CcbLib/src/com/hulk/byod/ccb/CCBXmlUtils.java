...
public class CCBXmlUtils {

    public static final String TAG = "CCBXmlUtils";
    ...
    public static String getHeartbeatReqTemplate(Context context, boolean original) {
        if (sHeartbeatReqTemplate == null) {
            sHeartbeatReqTemplate = readRequestXmlText(context, CCBManager.HEARTBEAT_TRADE_CODE, original);
        }
    ...
    public static String getAssetReqXmlName(String tranCode) {
        return "ccb/" + tranCode + "_REQ.xml";
    }

    public static String getAssetRespDemoXmlName(String tranCode) {
        return "ccb/" + tranCode + "_RESP.xml";
    }

    private static String getDir() {
        return Environment.getExternalStorageDirectory() + File.separator + "ccbXml" + File.separator;
    }
