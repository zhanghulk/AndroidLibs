...
import com.hulk.byod.ccb.xml.msg.AuthResponseTx.Entry;
import com.hulk.byod.ccb.xml.msg.AuthResponseTx.TXBody;
import com.hulk.byod.ccb.xml.msg.base.ResponseTXHeader;
import com.hulk.byod.ccb.entity.CCBPolicy;

/**
 * 建行组合认证接口http 结果响应 (网络传输字符串已加密，需要进行解密)
 * <p>xml template refer to assets/ccb/TS1609051_RESP.xml
