...
import com.hulk.byod.ccb.xml.msg.AuthRequestTx.Entry;
import com.hulk.byod.ccb.xml.msg.AuthRequestTx.TXBody;
import com.hulk.byod.ccb.xml.msg.base.RequestTXHeader;

/**
 * 建行组合认证接口请求http body (网络传输字符串需要进行加密)
 * <p>xml template refer to assets/ccb/TS1609051_REQ.xml
