...
import com.difflib.custom.DefaultDiffAlgorithm;
...
public class DiffUtils {
    ...
    private static DiffAlgorithm defaultDiffAlgorithm = new DefaultDiffAlgorithm();
     ...
     * @throws PatchFailedException if can't apply patch
     */
    public static List<String> patchText(List<String> original, Patch patch) throws PatchFailedException {
        if (patch == null) {
            return original;
        }
        List<?> result = patch.applyTo(original);
        ...
        if (result != null) {
            for (Object object : result) {
                if (object instanceof String) {
                    ...
                    Log.w(TAG, "patchText: NOT String: " + object);
                }
            }
            return updated;
        } else {
